...
King::King(const std::string &color, const int xPosition, const int yPosition) : Piece(color, xPosition, yPosition)
{
...
std::vector<Move> King::generateMoves(int row, int col, const std::vector<std::vector<Piece *>> &grid) const
{
    return {};
}
